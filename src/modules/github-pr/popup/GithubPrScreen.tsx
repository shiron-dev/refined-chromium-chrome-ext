...
async function fetchPopupState(): Promise<PopupStateResponse> {
  ...
  const response = await extensionApi.runtime.sendMessage({ moduleId: "githubPr", action: "getPopupState" }) as Partial<PopupStateResponse>;
...
async function registerCurrentPr(): Promise<RegisterResponse> {
  ...
  return extensionApi.runtime.sendMessage({ moduleId: "githubPr", action: "registerCurrent" }) as Promise<RegisterResponse>;
}
...
async function untrackCurrentPr(): Promise<UntrackResponse> {
  ...
  return extensionApi.runtime.sendMessage({ moduleId: "githubPr", action: "untrackCurrent" }) as Promise<UntrackResponse>;
}
...
async function reloadTrackedPrs(): Promise<ReloadTrackedPrsResponse> {
  ...
  return extensionApi.runtime.sendMessage({ moduleId: "githubPr", action: "reloadTrackedPrs" }) as Promise<ReloadTrackedPrsResponse>;
}
...
function sortTrackedPrItems(items: TrackedPrItem[]): TrackedPrItem[] {
  ...
  return items.slice().sort((a: TrackedPrItem, b: TrackedPrItem) => {
...
export default function GithubPrScreen({ onBack }: { onBack: () => void }) {
